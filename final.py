...
note = {"Имя пользователя ": username, "Заголовок заметки ": title, "Описание заметки ": content,
        "Статус заметки ": status, "Дата создания заметки ": created_date[:5],
        "Дата истечения заметки ": issue_date[:5], "Подзаголовки ": [title_1, title_2, title_3]}
print(note)
